...
const aggregateData = (data: OrderRevenueData[], scale: 'datewise' | 'weekwise' | 'monthwise' | 'yearwise') => {
    const aggregated: { [key: string]: { date: string; orders: number; revenue: number } } = {};
...
export const OrderRevenueChart: React.FC<OrderRevenueChartProps> = ({ data, scale }) => {
